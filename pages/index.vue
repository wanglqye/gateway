                ...
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href=""><img src="../assets/picture/logo.png" alt="Site Logo"></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="../assets/picture/1.jpg"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="../assets/picture/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="../assets/picture/31.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                                <div class="hero-slide-image">
                                    <img src="../assets/picture/slider-1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hero-slide-item slider-height swiper-slide d-flex">
                    <div class="container align-self-center">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                                <div class="hero-slide-image">
                                    <img src="../assets/picture/slider-2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="category-slider swiper-container" data-aos="fade-up">
                <div class="category-wrapper swiper-wrapper">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="../assets/picture/12.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="../assets/picture/22.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="../assets/picture/31.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="../assets/picture/41.png" alt="">
                    ...
                    <div class="swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="../assets/picture/5.png" alt="">
                            ...
                            <div class="row">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/1.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/2.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/31.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/41.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/5.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/6.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/7.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/8.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/9.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/10.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/11.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/12.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                            </span>
                                            <div class="actions">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/13.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/14.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                            </span>
                                            <div class="actions">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up" data-aos-delay="800">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="../assets/picture/15.jpg" alt="Product">
                                                <img class="hover-image" src="../assets/picture/16.jpg" alt="Product">
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <a href="shop-left-sidebar.html" class="banner">
                        <img src="../assets/picture/110.jpg" alt="">
                ...
                <div class="col-lg-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <a href="shop-left-sidebar.html" class="banner">
                        <img src="../assets/picture/23.jpg" alt="">
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="../assets/picture/19.jpg"
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="../assets/picture/22.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="../assets/picture/33.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="../assets/picture/43.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <div class="insta-wrapper">
                        <a href="javascript:;" target="_blank"><img class="w-100" src="../assets/picture/11.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                    <div class="insta-wrapper">
                        <a href="javascript:;" target="_blank"><img class="w-100" src="../assets/picture/21.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-xs-30px" data-aos="fade-up" data-aos-delay="600">
                    <div class="insta-wrapper">
                        <a href="javascript:;" target="_blank"><img class="w-100" src="../assets/picture/3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 " data-aos="fade-up" data-aos-delay="800">
                    <div class="insta-wrapper">
                        <a href="javascript:;" target="_blank"><img class="w-100" src="../assets/picture/4.png" alt="">
                                    ...
                                    <div id="mc_embed_signup" class="subscribe-form">
                                        <form id="mc-embedded-subscribe-form" class="validate" target="_blank"
                                            ...
                                            <div id="mc_embed_signup_scroll" class="mc-form">
                                                <input class="email" type="email" placeholder="Your Mail*" name="EMAIL"
                                                    value="">
                    ...
                    <div class="row flex-sm-row-reverse">
                        <div class="col-md-6 text-end">
                            <div class="payment-link">
                                <img src="../assets/picture/payment.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 text-start">
                            <p class="copy-text">Copyright &copy; 2023.Company name All rights reserved.<a target="_blank"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12 mb-lm-30px mb-sm-30px">
                            ...
                            <div class="swiper-container gallery-top mb-20px">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="../assets/picture/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="../assets/picture/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="../assets/picture/31.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="../assets/picture/41.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="../assets/picture/5.jpg" alt="">
                                    </div>
                                </div>
                            </div>
...
const params = {
    "lookPointId": "715dde9ca0ee4afe8be7faa5169ecd54",
    "preview": true,
    "producePoster": true,
    "remarksFlag": true
}
const {data} = await useGetData(params)
useHead({
        title: data.lookPointNewsDetail.title,
        meta: [
            { hid: 'keywords', name: 'keywords', content: data.lookPointNewsDetail.creatorInfo }
        ]
    })
</script>
